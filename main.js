...
const heading = document.getElementById("main-header"); // Select using getElementByID
const h1 = document.querySelector("#main-header"); // Select using querySelector
...
classList.add("highlighted"); // Adding a class name to a classlist
// classList.remove("highlighted"); // Removing a class name from a classlist
...
const section = document.getElementById("overview"); // Selecting element by id using getElementById method

const section2 = document.querySelector("#overview");
console.log(section2); // Selecting element by id using querySelector method
...
const overviewParagraph2 = section2.getElementsByTagName("p")[0];
console.log(overviewParagraph2);

// 2.3: Get the class name (or names) of the element you found in the previous step.
//    Hint: DOM elements have a property that represents their classes.

console.log(overviewParagraph.classList);
...
newParagraph.textContent = "This is a new paragraph"; // method1
newParagraph.innerText = "This is a new paragraph"; // method2
newParagraph.append("This is a new paragraph"); // method3

// 2.6: Add the same class name (or names) you retrieved in step 2.3 to the newly created paragraph element's class list.
//    Hint: Look for methods to add classes to an element's class list.

newParagraph.classList.add("breakout4"); // method 1
newParagraph.className = "breakout4"; // method 2
newParagraph.setAttribute("class", "breakout4"); // method 3
...
// overview.appendChild(newParagraph);
// history.append(newParagraph);

const overviewSection = document.getElementById("overview"); // Selecting parent element
overviewSection.append(newParagraph);
...
const list2 = document.querySelector('#features ul li') // Method 1
const list = featuresList.firstElementChild; // Method 2
...
console.log(featuresList.children[0].textContent)
...
//     const list = featuresList.firstElementChild; // block scope
//     featuresList.removeChild(list);
// }
...
const featuresList1 = document.querySelector('#features ul');
console.log(featuresList1);

// console.log(featuresList.lastElementChild.textContent)
...
while (featuresList.lastElementChild) {
    featuresList.removeChild(featuresList.lastElementChild);
}